...
function newTime(string, number) {
  ...
  const finalHour = hourInt === 0 ? '0' + hourInt : hourInt
  const finalMinute = minuteInt < 10 ? '0' + minuteInt : minuteInt
...
module.exports = {
  ...
  b: excla, // 2. change undefined to be the name of the function defined to return the string with exclamations (the second todo)
  c: newTime // etc
}

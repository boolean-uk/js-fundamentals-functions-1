...
//
// TODO: write code below
function exclaimString(s, n) {
  return s.toUpperCase() + '!'.repeat(n)
}
...
module.exports = {
  ...
  b: exclaimString, // 2. change undefined to be the name of the function defined to return the string with exclamations (the second todo)
  c: addTime // etc
}

...
function countStringsInArray(arr) {
  return arr.reduce((sum, e) => (typeof e === 'string' ? sum + 1 : sum), 0)
}
...
//
// TODO: write code below
function includeAmazingEdward(obj) {
  if (!Object.keys(obj).includes('edward')) {
    return { ...obj, edward: 'amazing' }
  } else return obj
}

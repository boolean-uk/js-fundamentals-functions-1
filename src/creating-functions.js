...
function smiley(name) {
  ...
  const response = 'Hi, ' + firstLetter + name.slice(1) + ' :)'
  return response
}

console.log(smiley('alistair'))
...
console.log(stringCount(['hi', 2, 4, 'you', 'wag']))
...
console.log(shinyGuy({ a: 123, edward: 2 }))

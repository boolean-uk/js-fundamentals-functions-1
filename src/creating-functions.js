...
// TODO: write code below
function capitalisesString(string) {
...
function greeting(name) {
  return `Hi, ${capitalisesString(name)} :)`
}
...
module.exports = {
  a: incrementsByOne, // 1. change undefined to be the name of the function you defined for the first TODO

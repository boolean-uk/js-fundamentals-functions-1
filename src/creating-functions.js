...
// TODO: write code below
function smiley(str){
  return 'Hi, '+str.charAt(0).toUpperCase() + str.slice(1).toLowerCase()+' :)'
  }
...
module.exports = {
  a: myfunction, // 1. change undefined to be the name of the function you defined for the first TODO
